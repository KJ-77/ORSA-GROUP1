...
const OurBranches = () => {
  ...
  useEffect(() => {
    ...
    if (branchesRef.current) {
      ScrollTrigger.create({
        ...
        start: "top 80%",
        onEnter: () => {
          const branchCards = branchesRef.current?.querySelectorAll(".branch-card");
          
          if (branchCards && branchCards.length > 0) {
            gsap.fromTo(branchCards, 
              { opacity: 0, y: 100, scale: 0.8, rotationY: 25 }, 
              { opacity: 1, y: 0, scale: 1, rotationY: 0, stagger: 0.2, duration: 1.2, ease: "power4.out" }
            );
          }
        },
      });
        ...
        onEnter: () => {
          ...
          if (contactCards && contactCards.length > 0) {
            gsap.fromTo(contactCards, 
              ...
              { opacity: 1, y: 0, scale: 1, rotationX: 0, stagger: 0.15, duration: 1.3, ease: "power4.out" }
            );
          }
        },
      });
  ...
  const branches = [
    ...
    },
    {
      ...
      description: "Our flagship retail store offering the complete range of ORSA olive oils and tasting experiences.",
      image: "/pic75.jpg",
      isHeadquarters: false
    }
  ];
  ...
  return (
    <div className="w-full overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-8 relative z-10">
          <div className="page-header-content backdrop-blur-md bg-white/10 rounded-3xl p-16 border border-white/20">
            ...
            <p className="text-lg md:text-2xl text-center text-gray-200 max-w-4xl mx-auto leading-relaxed">
              Discover our locations across Belgium where you can experience the finest Lebanese olive oils and connect with our passionate team.
            </p>
          </div>
        </div>
      </div>
                ...
                <div className={`relative ${index % 2 === 1 ? "md:col-start-2" : ""}`}>
                  <div className="backdrop-blur-md bg-white/80 rounded-3xl p-4 md:p-6 shadow-2xl border border-white/20 transform-gpu">
                    <img
                      src={branch.image}
                      alt={branch.name}
                      className="w-full h-64 md:h-80 object-cover rounded-2xl transition-transform duration-700 hover:scale-105"
                    />
                  ...
                  <div className="backdrop-blur-md bg-white/80 rounded-3xl p-8 md:p-10 shadow-2xl border border-white/20">
                    ...
                    <div className="space-y-4 mb-8">
                      <div className="flex items-start space-x-4">
                        ...
                        <div>
                          <p className="text-gray-800 font-semibold text-sm md:text-base">Address</p>
                          <p className="text-gray-600 text-xs md:text-sm">{branch.address}</p>
                        </div>
                      </div>
                      ...
                      <div className="flex items-start space-x-4">
                        ...
                        <div>
                          <p className="text-gray-800 font-semibold text-sm md:text-base">Phone</p>
                          <p className="text-gray-600 text-xs md:text-sm">{branch.phone}</p>
                        </div>
                      </div>
                      ...
                      <div className="flex items-start space-x-4">
                        ...
                        <div>
                          <p className="text-gray-800 font-semibold text-sm md:text-base">Email</p>
                          <p className="text-gray-600 text-xs md:text-sm">{branch.email}</p>
                        </div>
                      </div>
                      ...
                      <div className="flex items-start space-x-4">
                        ...
                        <div>
                          <p className="text-gray-800 font-semibold text-sm md:text-base">Hours</p>
                          <p className="text-gray-600 text-xs md:text-sm">{branch.hours}</p>
                        </div>
                      </div>
                    </div>
      ...
      <section ref={contactRef} className="py-32 bg-gradient-to-br from-slate-900 via-yellow-900 to-slate-900 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-8 relative z-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="contact-card backdrop-blur-md bg-white/10 rounded-3xl p-8 border border-white/20 text-center text-white transform-gpu">
              ...
              <p className="text-gray-300 text-sm leading-relaxed mb-4">Speak directly with our team</p>
              <div className="space-y-2">
                <p className="text-yellow-300 font-semibold">+32 466 31 69 14</p>
                <p className="text-yellow-300 font-semibold">+32 478 69 25 86</p>
              </div>
            </div>
            ...
            <div className="contact-card backdrop-blur-md bg-white/10 rounded-3xl p-8 border border-white/20 text-center text-white transform-gpu">
              ...
              <p className="text-gray-300 text-sm leading-relaxed mb-4">Send us your inquiries</p>
            ...
            <div className="contact-card backdrop-blur-md bg-white/10 rounded-3xl p-8 border border-white/20 text-center text-white transform-gpu">
              ...
              <p className="text-gray-300 text-sm leading-relaxed mb-4">Chat with us instantly</p>
              <a 
